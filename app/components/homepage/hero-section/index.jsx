...
import { BsGithub, BsLinkedin, BsStackOverflow, BsFacebook, BsTwitter, BsTelegram } from "react-icons/bs";
...
function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-between py-3 lg:py-9">
      <Image
        src="/hero.svg"
        alt="Hero"
        width={1572}
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] my-auto">
